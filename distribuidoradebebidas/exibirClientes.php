...
<div class="container container-tbl">
    ...
    ?>
        <tr>
            ...
            <td>
                <a href="controllers/controllerCliente.php?opcao=3&cnpj=<?php echo $cliente->cnpj ?>" >
                ...
                &nbsp&nbsp&nbsp
                <a  href="controllers/controllerCliente.php?opcao=4&cnpj=<?php echo $cliente->cnpj ?>">
