...
foreach ($categorias as $cat) {
    ...
    ?>
      ...
      <hr class="d-sm-none">
			 ...
			 <center><a href="bebidas.php" =><button type="button" class="btn btn-outline-dark">Limpar FIltro</button></a></center>
...
$idcat = htmlspecialchars($_POST['txtCategoriaBebida']);
$bebidaDAO           = new bebidaDAO();
$bebidas             = $bebidaDAO->getBebidas();
$bebidasEstoque = array();
foreach ($bebidas as $bebida) {
	
    if ($bebida->qde_estoque > 0 && $bebida->id_categoria ==$idcat) {//verificando estoque antes de exibir bebidas disponiveis
